import { generateCode,showModal,hideModal,addClientToTable,fetchAndPopulateTable, fetchapi, showCodeModal,reset} from "./function.js";
import { Transaction,Client,User } from "./types.js";
import {container,fournisseurSelect,expediteurSpan,transactionSpan,destinataireSpan,accountNumber,nameInput,recipientAcc,recipientName,recipientDiv,submitButton,modal,modalButton,codeSpan,infoButton,historique,montantInput,errorDiv,cancelButton,transactionSelect,closeHistory,addClientButton,addAccountButton,addClientModal,closeClientModal,phoneNumberInput,addClientForm,addAccountModal,saveAccount,
 closeAccountModal, clientsModal, tableBody, clientlistButton,closeClientsList, API, saveClientList
,filterInput,filterSelect,historyOKButton,retraitButton,retraitCodeInput,retraitModal,retraitProviderSelect,retraitTelInput,saveRetraitButton, closeRetraitModal,validationBox,retraitError} from './dom.js';
